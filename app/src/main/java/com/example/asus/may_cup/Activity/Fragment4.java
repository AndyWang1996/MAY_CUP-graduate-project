...
public class Fragment4 extends Fragment {
    ...
    private void init(){
        webView = root.findViewById(R.id.webView_4_blog);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_4_blogs, container, false);
        bundle = getActivity().getIntent().getBundleExtra("web");
        if (bundle != null){
